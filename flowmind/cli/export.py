...
def export_command(
    ...
    示例:
        flowmind export --output ./export/model.tar.gz
        flowmind export --format zip --output ./export/model.zip
        flowmind export --format json --output ./export/domain.json
    """
