...
from flowmind.policies.base_policy import Policy, PolicyConfig, PolicyPrediction
from flowmind.shared.constants import DegradationReason, ACTION_DEFAULT_FALLBACK
from flowmind.shared.llm import create_llm_client
from flowmind.shared.llm.base_client import LLMClient
from flowmind.retrieval.base_retriever import SearchResult

if TYPE_CHECKING:
    from flowmind.core.tracker import DialogueStateTracker
    from flowmind.core.domain import Domain
    from flowmind.dialogue_understanding.flow import FlowsList
    from flowmind.dialogue_understanding.stack.stack_frame import StackFrame
...
"""
    ...
    def does_support_stack_frame(self, frame: Optional[Any] = None) -> bool:
        ...
        Returns:
            是否支持处理该栈帧
        """
        from flowmind.dialogue_understanding.stack.stack_frame import (
            SearchStackFrame,
            ChitChatStackFrame,
