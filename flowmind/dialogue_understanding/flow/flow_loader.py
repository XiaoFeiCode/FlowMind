...
from flowmind.dialogue_understanding.flow.flow import Flow, FlowsList
from flowmind.shared.yaml_loader import read_yaml_file, read_yaml_files
from flowmind.shared.exceptions import ConfigurationException
...
class FlowLoader:
    ...
    def load_from_string(self, yaml_string: str) -> FlowsList:
        ...
        Returns:
            FlowsList实例
        """
        from flowmind.shared.yaml_loader import read_yaml_string
