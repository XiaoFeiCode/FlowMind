...
class ConfigurationException(FlowMindException):
    """配置异常
...
class ModelNotFound(FlowMindException):
    """模型未找到异常
...
class ModelLoadException(FlowMindException):
    """模型加载异常
...
class ModelTrainingException(FlowMindException):
    """模型训练异常
...
class LLMException(FlowMindException):
    """LLM异常基类
...
class TrackerStoreException(FlowMindException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(FlowMindException):
    """对话理解异常基类
...
class ActionException(FlowMindException):
    """Action异常基类
...
class ChannelException(FlowMindException):
    """通道异常基类
...
class GraphException(FlowMindException):
    """图引擎异常基类
...
class RetrievalException(FlowMindException):
    """检索异常基类
...
class ValidationException(FlowMindException):
    """验证异常基类
